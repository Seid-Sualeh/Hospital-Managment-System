    ...
    <div style={{ paddingTop: "6rem" }}>
      ...
      <section className="bg-light py-5 border-bottom border-light">
        <div className="container text-center">
          ...
          >
            Have questions about system setup, custom cloud deployment, or
            security features? Reach out to our technical team.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="row g-5">
            ...
            <div className="col-lg-5">
              <h3 className="fw-bold public-display-font text-dark mb-4">
                Connect Directly
              </h3>
                ...
                <div className="contact-info-item">
                  ...
                  <div>
                    ...
                    <p className="text-secondary small mb-0">
                      Bole District, Behind Friendship Mall, Addis Ababa,
                      Ethiopia
                    </p>
                  </div>
                </div>
              ...
              <div
                className="card border-0 bg-light p-3 rounded-4 overflow-hidden"
              ...
              >
                <div className="position-absolute top-50 start-50 translate-middle text-center opacity-10">
                  <MapPin size={50} className="text-success" />
                </div>
                <div className="position-relative z-2">
                  <h6 className="fw-bold text-dark mb-2">Technical HQ</h6>
                  <p className="text-secondary small mb-4">
                    Located in the tech and medical hub of Addis Ababa.
                  </p>

                  {/* CSS Map Pin Animation */}
                  <div
                    className="d-flex align-items-center gap-3 bg-white p-3 rounded-3 shadow-sm"
                  ...
                  >
                    ...
                    >
                      ...
                      ></div>
                      <div
                        className="position-absolute  rounded-circle border border-primary border-2 opacity-50"
                        style={{
                          width: "16px",
                          height: "16px",
                          top: "0",
            ...
            <div className="col-lg-7">
              <div className="card p-4 p-md-5 border-0 shadow-sm rounded-4 glass-card-light">
                <h3 className="fw-bold public-display-font text-dark mb-2">
                  Send Message
                </h3>
                <p className="text-secondary small mb-4">
                  Complete the form below and an engineer will contact you
                  shortly.
                </p>

                {success && (
                  <div
                    className="alert alert-success d-flex align-items-center gap-2 mb-4 border-0 rounded-3"
                    style={{
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-12">
                      <button
                        type="submit"
                        disabled={submitting}
                        className="btn  d-inline-flex align-items-center gap-2 px-4 py-2.5"
                        style={{
                          boxShadow: "0 4px 15px rgba(45, 92, 254, 0.3)",
